...
var Paul_Pio = function (prop) {
    var current = {
		...
		about: document.location.protocol +'//' + document.location.hostname +'/' + 'about'
    };
    ...
    var action = {
        ...
        touch: function () {
            current.canvas.onclick = function () {
                modules.render(prop.content.touch || ["你在干什么？", "再摸我就报警了！", "加大力度啊！！"]);
            };
        },
        // 右侧按钮
        buttons: function () {
            ...
            elements.skin.onclick = function () {
                ...
                prop.content.skin && prop.content.skin[1] ? modules.render(prop.content.skin[1]) : modules.render("新老婆来了！");
            };
            elements.skin.onmouseover = function () {
                prop.content.skin && prop.content.skin[0] ? modules.render(prop.content.skin[0]) : modules.render("什么？想换个新老婆？");
            };
            if(prop.model.length > 1) current.menu.appendChild(elements.skin);

            // 关于我
            elements.info.onclick = function () {
                window.open(current.about);
            };
